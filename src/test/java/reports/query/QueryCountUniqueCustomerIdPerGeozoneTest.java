...
public class QueryCountUniqueCustomerIdPerGeozoneTest {
    public static final Logger LOGGER =
            Logger.getLogger(QueryCountUniqueCustomerIdPerGeozoneTest.class.getClass().getName());
    @Test
    public void getUniqueCountCustomerPerGeozoneTest() throws LineException {
        ...
        QueryCountUniqueCustomerIdPerGeozone classUnderTest = new QueryCountUniqueCustomerIdPerGeozone(queryDao);
